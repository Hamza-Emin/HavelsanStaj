...
load_path = r'C:\Users\Hamza\Desktop\dilarafastthreadbirleşimi\spacy_trained_model' 
...
def Dependency_Parser(entities:list, text:str):
    ...
    print(f"aaaaaaaaaaaaaaaaaaaaaaaaa{result}")
    sentence_results = []
...
# Load tokenizer
path = r"C:\Users\Hamza\Desktop\dilarafastthreadbirleşimi\path-to-save"
...
sentence1 = "Turk Telekom her yönden çok daha iyi. Vodafone kullanıyorum ve 70 TL paket ücreti ödüyorum, 15gb 1000dk veriyor. Pahalı geliyor. Turkcell konusunda ise emin değilim."
sentence2 = "Turkcell'den çok memnun kaldım ama Vodafone için aynı şeyleri söyleyemem. Hiç memnun kalmadım."
sentence3 = "al birini vur ötekine. kurumsal dolandırıcılardan bıktım @turkcell @vodafonetr"
sentence4 = "turkcell çok pahalı. aynı koşullardaki tarifelere bakınca mecburen vodafone tercih ediyorum"
sentence5 = "turkcell kazık. türk telekom ekonomik ama çoğu yerde çekmiyor. i̇kisinin ortası vodafone. çekimide öyle bazılarının dediği gibi kötü değil"
sentence6 = "vodafone inanılmaz pahalı. paketim bitmesine 1 gün kala konuşma dk’kam bitti. anında 24 tl yapıştırıp, 1 günlüğüne 250 dakika verdiler. hemde hiç sormuyorlar. şikayet hakkım bile yokmuş.  yılım dolduğu an turktelekom ‘a geçmeyi düşünüyorum, bakalım."
sentence7 = "al bende o kadar ankara’nın göbeğinde çekmiyor. bide kalite diyene ayar oluyorum. fazla faturalarda cabası. vodafone"
sentence8= "bende sıkıntı yok valla turkcell pişmanlıktır. vodafone candır."
sentence9= "hepsi halkı soymaya,cebinden haksızca para kazanmaya yemin etmiş sanki. al birini vur diğerine zehir zıkkım olsun. vodafone;0"
sentence10 = "Turk Telekom kullanmaya başladım başlayalı gençleştim resmen. Vodafone kullanırken kelimenin tam anlamıyla yaşlanmıştım."


print(my_main(sentence1))
print(my_main(sentence2))
print(my_main(sentence3))
print(my_main(sentence4))
print(my_main(sentence5))
print(my_main(sentence6))
print(my_main(sentence7))
print(my_main(sentence8))
print(my_main(sentence9))
print(my_main(sentence10))
