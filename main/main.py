...
#sorunlu duygu iki kere yazıyor sentence = "tarifenin içeriğinde sosyal medya ( whatsapp instagram facebook twitter) youtubecom sınırsız olduğu söylendi bana."
def ab_model(text): 
